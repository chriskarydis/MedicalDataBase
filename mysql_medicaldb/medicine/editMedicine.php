...
<body>
    <div class="container">
        ...
        $editSQL = "UPDATE medicine SET med_name='$med_name', med_type='$med_type', expirationdate='$expirationdate', activeingredients='$activeingredients', med_usage='$med_usage', sideeffects='$sideeffects', indications='$indications', prescreptionneeded='$prescreptionneeded' WHERE medicineid='$medicineid'";
