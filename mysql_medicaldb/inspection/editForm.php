...
<head>
    <meta charset="UTF-8">
    <title>Editing Inspection Data - Group 33 Health Insurance App</title>
    <style>
...
<body>
    <div class="container">
        <?php 
            ...
            $sql = "SELECT * FROM inspection WHERE visitid='$visitid'";
        ...
        ?>
        <form action='editInspection.php' method='post'> 
            ...
            <input id='statebetween' name='statebetween' type='text' value='<?php echo $statebetween; ?>' > <br><br>
