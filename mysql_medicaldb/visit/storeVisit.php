...
<body>
    <div class="container">
        ...
        $insertSQL = "INSERT INTO visit (visitid, amka, doctorid, hospitalclinicid, visit_date, visit_type) 
                      VALUES ('$visitid', '$amka', '$doctorid', '$hospitalclinicid', '$visit_date', '$visit_type')";
