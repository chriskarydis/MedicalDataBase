...
<head>
    <meta charset="UTF-8">
    <title>Delete Checkup - Group 33 Health Insurance App</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Delete Checkup - Group 33 Health Insurance App</h1>
        </div>
        ...
        $deleteSql = "DELETE FROM checkup WHERE visitid='$visitid'";

        if ($result = $conn->query($deleteSql)) {
            echo "<p>The checkup record is deleted</p>";
        } else {
